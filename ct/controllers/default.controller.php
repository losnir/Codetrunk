...
class defaultController extends Controller
{
    ...
    */
    function __construct() {
      Codetrunk::getInstance()->addView("Default", "default");
    }
   ...
   function showDefault() {
      ...
      Codetrunk::getInstance()->wRenderer->appendContentHook(array(Codetrunk::getInstance()->getView("Default"), 'renderDefault'), $Params);
      return true;
   }
}
?>