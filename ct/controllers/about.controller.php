...
class aboutController extends Controller
{
    ...
    */
   function showAbout() {
      Codetrunk::getInstance()->wRenderer->setTitle("About ".Codetrunk::getInstance()->wRenderer->getTitle());
      Codetrunk::getInstance()->wRenderer->appendContentHook(array($this, 'renderAbout'), func_get_args());
      return true;
   }
   ...
   function renderAbout() {
      ?>
               <div class="title nRound3 round3"><img src="<?=ROOT?>/images/icons/information.png" width="16" height="16" alt="" style="margin-right: 4px;" class="icon pngfix" /> About Codetrunk and me</div>
               <div style="font: 15px Arial;"><div class="clearfix">&nbsp;</div>
                  ...
                  <p style="border-bottom: 1px solid #90a9c8; color: #90a9c8; margin: 4px 0 10px 0; padding-bottom: 2px;">About Me</p>
                     <a href="http://www.losnir.com/" target="_blank" class="thumbnail right nRound3 round3" title="Nir Azuelos"><img alt="Nir Azuelos" src="<?=ROOT?>/images/nirazuelos.png" /></a>
                  ...
                  <p style="border-bottom: 1px solid #90a9c8; color: #90a9c8; margin: 4px 0 10px 0; padding-bottom: 2px;">Codetrunk Software</p>
                     <a href="http://www.opensource.org/licenses/agpl-v3.html" class="thumbnail right nRound3 round3" title="AGPL v3" target="_blank"><img src="<?=ROOT?>/images/agplv3-155x51.png" width="155" height="51" alt="AGPL v3" /></a>
                     The software behind <b>Codetrunk</b> is open source and published under the <a target="_blank" href="http://www.opensource.org/licenses/agpl-v3.html">GNU Affero General Public License v3</a>.
                     ...
                     <ul style="margin: 16px 0 16px 16px;">
                        <li>You can obtain the source code by <a href="<?=ROOT?>/codetrunk.11.beta.zip">clicking here</a>.</li>
                        <li>A <a target="_blank" href="<?=ROOT?>/doc">documentation</a> generated with phpDoc is also available.</li>
                     </ul>
